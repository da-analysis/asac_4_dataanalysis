...
# MAGIC %md
# MAGIC - https://github.com/sberbank-ai-lab/RePlay/blob/main/experiments/01_replay_basics.ipynb
# MAGIC - https://sberbank-ai-lab.github.io/RePlay/
# MAGIC
...
# MAGIC %pip install replay-rec

# COMMAND ----------

# MAGIC %pip install replay-rec[spark]

# COMMAND ----------

# MAGIC %pip install --upgrade pip wheel

# COMMAND ----------

!git clone git@github.com:sb-ai-lab/RePlay.git cd RePlay
